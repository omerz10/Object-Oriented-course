...
/**
 * animations.GameLevel comprise of GUI, sprites.Sprite collection and environment.
 */
public class GameLevel implements Animation {
    ...
    /**
     * Initialize a new game: create the Blocks and collisions.Ball (and sprites.Paddle) and add them to the game.
     */
    ...
    public void createDeathRegion() {
        Block deathBlock = new Block(new Rectangle(new Point(20, HEIGHT), WIDTH - 40, 20), null);
