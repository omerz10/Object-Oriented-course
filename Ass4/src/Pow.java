...
public class Pow extends BinaryExpression implements Expression {
    ...
    /**
     * Construct Pow with two expressions.
     *
    ...
    /**
     * Construct Pow with expression and number.
     *
     * @param leftExp  an expression
    ...
    /**
     * Construct Pow with two numbers.
     *
     * @param leftExp  a number
     * @param rightExp a number
     */
    ...
    /**
     * Construct Pow with expression and variable.
     *
     * @param leftExp  an expression
    ...
    /**
     * Construct Pow with two variables.
     *
     * @param leftExp  a variable
    ...
    public Expression differentiate(String var) {
        return new Mult(new Pow(this.getExpression1(), this.getExpression2()),
                new Plus(new Mult(this.getExpression1().differentiate(var),
                        new Div(super.getExpression2(), this.getExpression1())),
