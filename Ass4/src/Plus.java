...
public class Plus extends BinaryExpression implements Expression {
    /**
     * Construct Plus with two expressions.
     *
    ...
    /**
     * Construct Plus with expression and number.
     *
     * @param leftExp  an expression
    ...
    /**
     * Construct Plus with two numbers.
     *
     * @param leftExp  a number
     * @param rightExp a number
     */
    ...
    /**
     * Construct Plus with expression and variable.
     *
     * @param leftExp  an expression
    ...
    /**
     * Construct Plus with two variables.
     *
     * @param leftExp  a variable
    ...
    public Expression differentiate(String var) {
        return (Expression) new Plus(this.getExpression1().differentiate(var),
    ...
    public Expression commutativeExp() {
        return new Plus(this.getExpression2(), this.getExpression1());
    }
